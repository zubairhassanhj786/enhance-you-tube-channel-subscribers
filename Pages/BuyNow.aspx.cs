    ...
    public partial class BuyNow : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                txnid.Value = "Waseem" + txnid.Value.ToString();
        ...
        protected void btnregister_Click(object sender, EventArgs e)
        {
            ...
            String text = key.Value.ToString() + "|" + txnid.Value.ToString() + "|" + amount + "|" + "Subscribers" + "|" + TextBox1.Text + "|" + TextBox4.Text + "|" + "1" + "|" + "1" + "|" + "1" + "|" + "1" + "|" + "1" + "||||||" + salt.Value.ToString();
            //Response.Write(text);
            ...
            data.Add("email", TextBox4.Text.Trim());
            data.Add("phone", TextBox3.Text.Trim());
            data.Add("productinfo", "Subscriber");
            data.Add("udf1", "1");
            data.Add("udf2", "1");
            data.Add("udf3", "1");
            data.Add("udf4", "1");
            ...
            data.Add("surl", "http://localhost:51158/success.aspx");
            data.Add("furl", "http://localhost:51158/failpayment.aspx");
